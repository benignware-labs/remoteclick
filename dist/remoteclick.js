...
eval("module.exports = __webpack_require__.p + \"page3.html\";\n\n//# sourceURL=webpack:///../test/fixtures/page3.html?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var unique_selector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! unique-selector */ \"../node_modules/unique-selector/lib/index.js\");\n/* harmony import */ var unique_selector__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(unique_selector__WEBPACK_IMPORTED_MODULE_0__);\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\nfunction remoteclick(selector) {\n  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n\n  var handleClick = function handleClick(event) {\n    var target = event.target.closest(selector);\n\n    if (target) {\n      // Get options\n      options = _objectSpread({\n        srcAttr: 'href',\n        mode: 'append',\n        history: false,\n        containerSelector: null,\n        pendingClass: 'is-pending'\n      }, typeof options === 'function' ? options(target) : options);\n      var container = options.containerSelector ? document.querySelector(options.containerSelector) : target.parentNode;\n      var href = target.getAttribute(options.srcAttr) || target.getAttribute(\"data-\".concat(options.srcAttr));\n\n      if (container && href) {\n        var url = new URL(href, window.location.href);\n        var containerSelector = options.containerSelector || unique_selector__WEBPACK_IMPORTED_MODULE_0___default()(container);\n        var targetSelector = unique_selector__WEBPACK_IMPORTED_MODULE_0___default()(target); // Add pending class\n\n        options.pendingClass.split(/\\s+/).forEach(function (className) {\n          target.classList.add(className);\n        }); // Fetch remote content\n\n        fetch(url.href, {// Request options\n        }).then(function (response) {\n          response.text().then(function (html) {\n            // Remove pending class\n            options.pendingClass.split(/\\s+/).forEach(function (className) {\n              target.classList.add(className);\n            }); // Parse html\n\n            var dom = document.createElement('div');\n            dom.innerHTML = html; // Find remote target\n\n            var remoteTarget = dom.querySelector(targetSelector);\n\n            if (remoteTarget) {\n              // Remove attributes\n              var _iteratorNormalCompletion = true;\n              var _didIteratorError = false;\n              var _iteratorError = undefined;\n\n              try {\n                for (var _iterator = dom.attributes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n                  var name = _step.value.name;\n                  target.removeAttribute(name);\n                } // Update attributes\n\n              } catch (err) {\n                _didIteratorError = true;\n                _iteratorError = err;\n              } finally {\n                try {\n                  if (!_iteratorNormalCompletion && _iterator.return != null) {\n                    _iterator.return();\n                  }\n                } finally {\n                  if (_didIteratorError) {\n                    throw _iteratorError;\n                  }\n                }\n              }\n\n              var _iteratorNormalCompletion2 = true;\n              var _didIteratorError2 = false;\n              var _iteratorError2 = undefined;\n\n              try {\n                for (var _iterator2 = remoteTarget.attributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n                  var _step2$value = _step2.value,\n                      name = _step2$value.name,\n                      value = _step2$value.value;\n                  target.setAttribute(name, value);\n                } // Update link content\n\n              } catch (err) {\n                _didIteratorError2 = true;\n                _iteratorError2 = err;\n              } finally {\n                try {\n                  if (!_iteratorNormalCompletion2 && _iterator2.return != null) {\n                    _iterator2.return();\n                  }\n                } finally {\n                  if (_didIteratorError2) {\n                    throw _iteratorError2;\n                  }\n                }\n              }\n\n              target.innerHTML = remoteTarget.innerHTML;\n            } else {\n              // End of list\n              target.parentNode.removeChild(target);\n            } // Find remote container\n\n\n            var remoteContainer = dom.querySelector(containerSelector);\n\n            if (remoteContainer) {\n              // Create content fragment\n              var fragment = document.createDocumentFragment(); // Take care of link wrappers\n\n              var remoteTargetWrapper = _toConsumableArray(remoteContainer.childNodes).find(function (child) {\n                return child.contains(remoteTarget);\n              }) || remoteTarget;\n              var targetWrapper = _toConsumableArray(container.childNodes).find(function (child) {\n                return child.contains(target);\n              }) || target;\n              var _iteratorNormalCompletion3 = true;\n              var _didIteratorError3 = false;\n              var _iteratorError3 = undefined;\n\n              try {\n                for (var _iterator3 = remoteContainer.children[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n                  var child = _step3.value;\n                  fragment.appendChild(child === remoteTargetWrapper ? targetWrapper : document.importNode(child, true));\n                } // Actually update dom content\n\n              } catch (err) {\n                _didIteratorError3 = true;\n                _iteratorError3 = err;\n              } finally {\n                try {\n                  if (!_iteratorNormalCompletion3 && _iterator3.return != null) {\n                    _iterator3.return();\n                  }\n                } finally {\n                  if (_didIteratorError3) {\n                    throw _iteratorError3;\n                  }\n                }\n              }\n\n              switch (options.mode) {\n                case 'update':\n                  container.appendChild(fragment);\n                  break;\n\n                case 'prepend':\n                  container.insertBefore(container.firstChild, fragment);\n                  break;\n\n                case 'append':\n                  container.appendChild(fragment);\n                  break;\n              }\n            } // History\n\n\n            if (options.history) {\n              // Find remote title\n              var title = (dom.querySelector(targetSelector) || {\n                title: document.title\n              }).title;\n              history.pushState({\n                title: title\n              }, title, url.href);\n            }\n          });\n        });\n      }\n\n      event.preventDefault();\n    }\n  };\n\n  window.addEventListener('click', handleClick);\n}\n\nif (typeof window !== 'undefined') {\n  window.remoteclick = remoteclick;\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (remoteclick);\n\n//# sourceURL=webpack:///./remoteclick.js?");
